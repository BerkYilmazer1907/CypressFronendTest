...
/// Login With TFA
describe('LhvPayment', function () {
    beforeEach(function () {
        cy.SingInLhv()
    })
            it('PaymentsGbpLhv', function () {
                cy.contains("Payments").click()
                cy.wait(3000);
                cy.contains("British Pound").click()
                cy.wait(3000);
                cy.get('.select2-selection__arrow').click()
                cy.get('.select2-results__options').find("li").contains("Glenn").click()
                cy.wait(5000);
            ...
            it('PaymentsEuroSepaLhv', function () {
                cy.contains("Payments").click()
                cy.wait(3000);
                cy.contains("Euro").click()
                cy.wait(3000);
                cy.get('.select2-selection__arrow').click()
                cy.get('.select2-results__options').find("li").contains("automationeuro").click()
                cy.wait(5000);
                cy.get("div.global-content div.page-content div.container div.dc-gen-wrap.steply div.payment-form-wrap.payment-form-wrap-1.clearfix form.payout-form-step1:nth-child(1) > input.btn-style.pull-right.full-mobile:nth-child(4)").click()
                cy.wait(3000);
                cy.get("#payamount").type('30')
